              ...
              <div class="dorik-navbar--wrapper dorik-nav-ynq9x73v-wrapper ">
                <div class="dorik-navbar dorik-nav-ynq9x73v ">
                  <div class="dorik-navbar--brand">
                    <a
                      ><img
                        src="https://i.postimg.cc/SNW6Hh3V/58f8bd900ed2bdaf7c12830c-Copie-removebg-preview.png"
                        width="80px"
                    /></a>
                  </div>
                  <button
            ...
            <div class="column-inner dorik-column-7sc812n1  1/1">
              <div class="dorik-wrapper dorik-heading-wahmdk55-wrapper ">
                <h1 class="dorik-heading dorik-heading-wahmdk55 ">
                  <span>Besoin d'une plate-forme commerciale ?</span>
                  </h1>
                  <h1 class="dorik-heading dorik-heading-wahmdk55 ">
                  <span>Bienvenu sur E-chry </span>
                </h1>
              </div>
              <div class="dorik-text dorik-text-s2wjxpc0 ">
              Des millions de marques parmi les plus prospères au monde font confiance à E-chry pour vendre, expédier et traiter les paiements n’importe où.
              </div>
              <div class="dorik-button-ra0ilohg-wrapper  ">
                <button  class="dorik-btn dorik-button-ra0ilohg"  onclick="window.location.href = 'http://localhost:3002/';" > Je suis fournisseur</button>
                <button class="dorik-btn dorik-button-ra0ilohg" onclick="window.location.href = 'http://localhost:3000/';" >Voir demo Client</button>
                <button class="dorik-btn dorik-button-ra0ilohg" onclick="window.location.href = 'http://localhost:4000/';" >Voir dashbord</button>
                </button>
              </div>
            </div>
          </div>
        ...
        <div class="dorik-row-w0t3z90u  flex">
          <div class="col-lg-1/2 ">
            <div class="column-inner dorik-column-b10ybbcb  1/2">
              ...
              Faire passer des commandes en toute liberté et flexibilité  en choisissant vos produits désirés .
              </div>
            ...
            <div class="column-inner dorik-column-7j5s3mam  1/2">
              ...
              <div class="dorik-wrapper dorik-heading-59sh807n-wrapper ">
                <h4 class="dorik-heading dorik-heading-59sh807n ">
                  <span>Créer votre site marchand</span>
                </h4>
              </div>
              <div class="dorik-text dorik-text-k2hh4pe3 ">
              Besoin d'une boutique en ligne? créant alors votre site marchand et bénéficiant  des fonctionnalités que nous fournissons  
              </div>
          ...
          <div class="col-lg-1/1 ">
            <div class="column-inner dorik-column-r3ivv2hb  1/1">
              ...
              <div class="dorik-wrapper dorik-heading-wq3ztfa6-wrapper ">
                ...
                >
                  <span>
                  Paiement sécurisé et transparent</span>
                </h2>
              </div>
              <div
        ...
        <div class="dorik-row-20hlfpdy  flex">
          <div class="col-lg-1/3 ">
            <div class="column-inner dorik-column-yvpaamen  1/3">
              ...
              Des transferts et paiements  transparents .
              </div>
            </div>
          </div>
          <div class="col-lg-1/3 ">
            <div class="column-inner dorik-column-4rv6ivje  1/3">
              ...
              Des transferts et paiements instantanés.
              </div>
            </div>
          </div>
          <div class="col-lg-1/3 ">
            <div class="column-inner dorik-column-nixkiu4x  1/3">
              ...
              <div class="dorik-wrapper dorik-heading-92l6l85l-wrapper ">
                <h3 class="dorik-heading dorik-heading-92l6l85l ">
                  <span>Réseau crypté</span>
                </h3>
              </div>
              <div class="dorik-text dorik-text-na6qelw4 ">
              Toutes les transactions sont basées sur l'infrastructure blockchain approuvée par la Banque Centrale afin de prévenir toute violation ou transaction frauduleuse.
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="col-lg-1/2 ">
            <div class="column-inner dorik-column-bub8wwuh  1/2">
              <div class="dorik-wrapper dorik-heading-bp4qfd24-wrapper ">
                <h2 class="dorik-heading dorik-heading-bp4qfd24 ">

                  <span>Accepter Cartes de Crédit</span>
                </h2>
              </div>
              <div class="dorik-wrapper dorik-heading-of7bgq7o-wrapper ">
                <h6 class="dorik-heading dorik-heading-of7bgq7o ">
                <span>Prochainement</span>
                </h6>
                <h2 class="dorik-heading dorik-heading-of7bgq7o ">
                  <span>Accepter toutes Cartes de Crédit</span>
                </h2>
              </div>
              <div class="dorik-text dorik-text-m5pbvdh1 ">
              Accepter tout paiement par carte de crédit
              </div>
            ...
            <div class="column-inner dorik-column-ksllkmnu  1/1">
              <div class="dorik-wrapper dorik-heading-5uihgmqj-wrapper ">
                <h5 class="dorik-heading dorik-heading-5uihgmqj ">
                  <span>Aujourd’hui nous souhaitons vous rappeler quelques bases du monde du commerce en ligne avec des citations d’entrepreneurs à succès et de célébrités inspirantes qui vont, on l’espère, vous rassurer, vous inspirer et vous motiver à continuer votre passion!</span>
                </h5>
              </div>
              ...
              <div class="dorik-text dorik-text-fpbgyh5o ">
              «« L’innovation distingue les leaders des suiveurs. » -Steve Jobs (1955 – 2011)-
            ...
            <div class="column-inner dorik-column-avaa5k12  1/2">
              <div class="dorik-wrapper dorik-heading-bwcm73gh-wrapper ">
                <h6 class="dorik-heading dorik-heading-bwcm73gh ">
                  <span>ÉCONOMIE ULTIME</span>
                </h6>
              </div>
              <div class="dorik-wrapper dorik-heading-e79i0yol-wrapper ">
                <h2 class="dorik-heading dorik-heading-e79i0yol ">
                  <span>La Recette magique qui permet d'économiser de l'argent </span>
                </h2>
              </div>
              <div class="dorik-text dorik-text-sba0pas5 ">
                Créer votre site marchand et passer des commandes par un simple clic et assis sur votre canapet 
              </div>
            ...
            <div class="column-inner dorik-column-9j1kuket  1/1">
              ...
              <div class="dorik-wrapper dorik-heading-gtclw1cx-wrapper ">
                <h2 class="dorik-heading dorik-heading-gtclw1cx ">
                  <span>
                  Tout dans une seule plate-forme</span>
                </h2>
              </div>
              ...
              <div class="dorik-iconText-a8022ec7-wrapper ">
                <div class="dorik-iconText-a8022ec7 ">
                  ...
                  ><span class="icon_text"
                    >Un design unique, efficace et adapté</span
                  >
                </div>
              </div>
                ...
                <div class="dorik-iconText-jcto15xy ">
                  <span
                    ...
                    >
                      ...
                      ></path></svg></span
                  ><span class="icon_text"
                    >Une expérience utilisateur optimisée</span
                  >
                </div>
              </div>
                ...
                <div class="dorik-iconText-0cdkv77o ">
                  <span
                    ...
                    >
                      ...
                      ></path></svg></span
                  ><span class="icon_text"
                    >Un tunnel de commandes optimisé pour les conversions</span
                  >
                </div>
              </div>
            </div>
                ...
                <div class="dorik-iconText-o6ljwp85 ">
                  <span
                    ...
                    >
                      ...
                      ></path></svg></span
                  ><span class="icon_text"
                    > Choisir & personnaliser un thème</span
                  >
                </div>
              </div>
                ...
                <div class="dorik-iconText-un1jvxj3 ">
                  <span
                    ...
                    >
                      ...
                      ></path></svg></span
                  ><span class="icon_text"
                    >Descriptif complet et Photos de qualité</span
                  >
                </div>
              </div>
            ...
            <div class="column-inner dorik-column-u2yoccyk  1/1">
              ...
              <div class="dorik-wrapper dorik-heading-tkr6vjiv-wrapper ">
                <h2 class="dorik-heading dorik-heading-tkr6vjiv ">
                  <span>Developpé  par une équipe super motivée</span>
                </h2>
              </div>
          ...
          <div class="col-lg-1/4 col-md-1/2 ">
            <div class="column-inner dorik-column-23ocsyy4  1/4">
              <div class="dorik-wrapper dorik-image-74sauopi-wrapper ">
                <img
                  src="https://i.postimg.cc/7L7nK59v/289730431-734055887775114-3706781326905814904-n-fococlipping-standard.png"
          ...
          <div class="col-lg-1/4 col-md-1/2 ">
            <div class="column-inner dorik-column-s36ccu9w  1/4">
              <div class="dorik-wrapper dorik-image-4v5dnhm4-wrapper ">
                <img
                  src="https://i.postimg.cc/bJS0ZsGV/288997557-603129910998061-8635732503076351209-n-fococlipping-standard.png"
            ...
            <div class="column-inner dorik-column-o9qvy6nh  1/1">
              ...
              <div class="dorik-wrapper dorik-heading-f2h6dsrw-wrapper ">
                <h2 class="dorik-heading dorik-heading-f2h6dsrw ">
                  <span
                    >
                    Prêt à essayer la plate-forme de finance et de paiement la plus avancée?</span
                  >
                </h2>
              </div>
